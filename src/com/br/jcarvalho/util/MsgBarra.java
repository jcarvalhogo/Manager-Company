...
public class MsgBarra {
    ...
    public static final String NOVO = "Registro em estado de Inserção";
    public static final String EDITE = "Registro em estado de Ediçãi";
    public static final String CANCEL = "Operação Cancelada";

    public static final String TITULO = "Banco de Dados";
    public static final String SALVO_COM_SUCESO = "Registro salvo com sucesso";
